...
export class createTables1678549481307 implements MigrationInterface {
    name = 'createTables1678549481307'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "schedules_users_properties" ("id" SERIAL NOT NULL, "date" date NOT NULL DEFAULT now(), "hour" TIME NOT NULL DEFAULT now(), "userId" integer, "realEstateId" integer, CONSTRAINT "PK_751450246dee9abc82a47dabc4c" PRIMARY KEY ("id"))`);
